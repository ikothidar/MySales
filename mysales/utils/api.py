...
# Local modules
from mysales.utils.models import SerializableClass
...
def success_response(
    ...
    """
    Generate a success  response with the provided data, status code,
    message, headers, cookies and cache response flag.
    Args:
        data (Any, optional): The data to be included in the response.
            Defaults to None.
        status (int, optional): The status code of the response.
            Defaults to 200.
        message (str, optional): The message to be included in the response.
            Defaults to None.
        headers (dict, optional): The headers to be included in the response.
            Defaults to None.
        cookies (dict, optional): The cookies to be included in the response.
            Defaults to None.
        cache_response (bool, optional): Flag to indicate if the response
...
def error_response(
    ...
    """
    Generate an error response with the given message, status code,
    headers and cookies.
    Args:
        message (str): The error message to be included in the response.
            Defaults to "Internal Server Error".
        status (int): The status code to be included in the response.
            Defaults to 500.
        headers (dict): A dictionary of additional headers to be
            included in the response. Defaults to None.
        cookies (dict): A dictionary of cookies to be included in the response.
            Defaults to None.
